...
class Dex():
    """ This class simplifies interactions with the decentralized exchange.
        ...
        .. note:: The methods of this class only deal with a single asset (at
                  ...
                  please use :class:`transnet.market.Market`.
    ...
    def returnFees(self):
        ...
        """
        from transnetbase.operations import operations
        r = {}
        obj, base = self.transnet.rpc.get_objects(["2.0.0", "1.3.0"])
    ...
    def close_debt_position(self, symbol, account=None):
        ...
        return self.transnet.finalizeOp(op, account["name"], "active")
